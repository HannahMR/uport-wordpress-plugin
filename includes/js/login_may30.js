...
// import { isMNID, decode } from 'mnid'
  // const isMNID = require('mnid').isMNID
  // const decode = require('mnid').decode
  const uportconnect = window.uportconnect
  // const appName = wp_uport_config.appName
  const appName = 'uport-wordpress-plugin'
  ...
  // // A QR code URI can then be used in a html img tag <img src="${qrCode}"/>
  // const loginForm = document.getElementById('loginform')
  // const qrcodedata = '<div img src="${qrCode}"/>'
  // loginForm.insertAdjacentHTML('afterend', qrcodedata)
  // }
